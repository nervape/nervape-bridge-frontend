...
import { TransactionBuilderExpectedMNFTData } from './utils/nft';
import { TransferNFTBuilder } from './utils/TransferNFTBuilder';
import BasicCollector from './utils/BasicCollector';
...
export class UnipassV3Wrapper {
    ...
    public async init() {
        console.log(sessionStorage.getItem('UP-A'));
